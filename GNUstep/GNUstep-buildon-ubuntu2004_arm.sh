...
echo "You might need to fix the configure script"
echo "Also: now creating symlink for objc headers so configure script finds them"
ln -s /usr/GNUstep/Local/Library/Headers/objc /usr/local/lib/
